...
console.log(createMenuItem('apple pie', '4', 'dessert'));
...
console.log(createMenuItem('peach cobbler', '4', 'dessert'));
console.log(createMenuItem('apple turnover', '4', 'dessert'));
...
console.log('task 5', addReview(reviews, 'Sarmad', '5', 'lovely place'));
